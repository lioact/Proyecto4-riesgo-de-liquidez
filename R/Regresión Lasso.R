...
# Función principal
ajustar_y_graficar <- function(df_banco, banco, variables_captacion, variables_macro) {
...
for (banco in names(bancos)) {
  ajustar_y_graficar(bancos[[banco]], banco, variables_captacion, variables_macro)
}
